...
function updateBarang(id) {
    ...
    let banyak_barang = document.getElementById(
        "edit_tambah_banyak_barang"
    ).value;
    let total_harga_barang = document.getElementById(
        "edit_tamba_total_barang"
    ).value;
    ...
    gettr.children[1].innerHTML = arr[id].nama_barang;
    gettr.children[2].innerHTML = arr[id].banyak_barang;
    gettr.children[3].innerHTML = Intl.NumberFormat("id-ID", {
        style: "currency",
        currency: "IDR",
        minimumFractionDigits: 0,
    }).format(arr[id].harga_barang);
...
function edit_hitung() {
    let harga_barang = document.getElementById(
        "edit_tambah_harga_barang"
    ).value;
    let banyak_barang = document.getElementById(
        "edit_tambah_banyak_barang"
    ).value;
    let jumlah = harga_barang * banyak_barang;
    document.getElementById("edit_tamba_total_barang").value = jumlah;
}
